...
namespace MultiShop.Catalog.Services.CategoryServices
{
        ...
        ICategoryService
    {
        public CategoryService(IDatabaseSettings databaseSettings, IMapper mapper,
            DomainExceptionRegistery domainExceptionRegistery) : base(databaseSettings, collectionName:databaseSettings.CategoryCollectionName, mapper,domainExceptionRegistery)
        {
        }
    }
}
